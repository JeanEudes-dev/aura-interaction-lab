...
DATA_ARC_LIFT = 0.34
PORTRAIT_PIP_SIZE = (320, 240)
PORTRAIT_PIP_MARGIN = 20

# Futuristic neon palette
GLOBE_CORE_COLOR = (0, 30, 40)
GLOBE_LINE_COLOR = (0, 255, 255)
GLOBE_BACK_LINE_COLOR = (0, 50, 60)
HUD_COLOR = (0, 255, 255)
PANEL_COLOR = (0, 0, 0)
PANEL_ACCENT = (0, 255, 255)
TEXT_PRIMARY = (200, 255, 255)
TEXT_SECONDARY = (100, 200, 200)
TEXT_ACCENT = (255, 0, 255)
CURSOR_COLOR = (0, 255, 255)
WARNING_COLOR = (255, 0, 0)
PORTRAIT_TINT = (0, 255, 255)
PORTRAIT_ALPHA = 1.0
